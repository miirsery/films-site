...
var favoriteList = document.querySelectorAll('.favorite-modal__list');
...
itemsBtn.forEach(function (el) {
  ...
  el.addEventListener('click', function (e) {
    ...
    favoriteList.querySelector('.favorite').insertAdjacentHTML('afterbegin', ' <div class="favorite-modal-left">');
    self.disabled;
  });
});
